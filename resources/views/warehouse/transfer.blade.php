                                    ...
                                    <form id="transferForm" method="POST" action="/warehouse-transfer">
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" name="quantity" id="quantity" placeholder="Quantity" min="1" value="{{ old('quantity') }}" class="form-control @error('quantity') is-invalid @enderror">
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('transfer.index') }}" class="btn btn-outline-info">
                                                Back
                                            </a>
