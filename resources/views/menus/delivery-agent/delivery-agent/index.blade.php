                    ...
                    <tbody>
                        ...
                        : '-' }}
                            ...
                            <td class="text-center" style="white-space:nowrap;">
                                ...
                                <a href="{{ route('grocery-shops.show', $agent->id) }}" class="btn btn-sm btn-primary">View</a>
                                @endif
                                @if(hasPermission('delivery_agent.edit'))
                                <a href="{{ route('grocery-shops.edit', $agent->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                @endif
                                @if(hasPermission('delivery_agent.delete'))
                                <form action="{{ route('grocery-shops.destroy', $agent->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
