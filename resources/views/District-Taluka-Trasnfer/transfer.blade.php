                         ...
                         <div class="col-12 col-md-10 col-lg-12">
                             <div class="card mb-4">
                                 <h4 class="card-header text-center">
                                     District-to-Taluka Warehouse Stock Transfer
                                 </h4>

                                 <div class="card-body">
                                     <form method="POST"
                                         action="{{ isset($transfer)
                                        ? route('district-taluka-transfer.update', $transfer->id)
                                        : route('district-taluka-transfer.store') }}">
                                         ...
                                         @if (request()->is('district-taluka-transfer/*/edit'))
                                         ...
                                         <a href="{{ route('district-taluka-transfer.index') }}" class="btn btn-success">Back</a>
