...
<div class="container">
    ...
    <div class="container bg-white mt-5 shadow rounded p-3">
        ...
        <h5 class="card-title mt-5">Taluka-Distribution Warehouse Stock Transfer</h5>
                        ...
                        <td>
                            @if($t->status == 0)
                                <div class="d-flex gap-1">
                                    <form method="POST"
                                        action="{{ route('taluka-distribution.transfer.approve', $t->id) }}">
                                        @csrf
                                    ...
                                    <form method="POST"
                                        action="{{ route('taluka-distribution.transfer.reject', $t->id) }}"
