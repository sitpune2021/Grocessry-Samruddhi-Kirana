...
<div class="container">
    ...
    <div class="container bg-white mt-5 shadow rounded p-3">
        ...
        <h5 class="card-title mt-5">District-Taluka Warehouse Stock Transfer</h5>
                        ...
                        <td>
                            @if($t->status == 0)
                                <div class="d-flex gap-1">
                                    <form method="POST"
                                        action="{{ route('district-taluka.transfer.approve', $t->id) }}">
                                        @csrf
                                    ...
                                    <form method="POST"
                                        action="{{ route('district-taluka.transfer.reject', $t->id) }}"
