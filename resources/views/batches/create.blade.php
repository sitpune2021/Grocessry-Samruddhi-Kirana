                                    ...
                                    <form method="POST"
                                        ...
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="batch_no" value="{{ $batch->batch_no ?? '' }}"
                                                    class="form-control @error('batch_no') is-invalid @enderror" placeholder="Batch Number">
                                                @error('batch_no')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" name="quantity" placeholder="Quantity" value="{{ $batch->quantity ?? '' }}" min="1"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="mfg_date" value="{{ $batch->mfg_date ?? '' }}"
