        ...
        <div class="card-datatable">
            ...
            <div class="row card-header flex-column flex-md-row pb-0">
                <div class="col-md-auto me-auto">
                    <h5 class="card-title">District To Taluka Warehouse Transfers</h5>
                </div>
                <div class="col-md-auto ms-auto mt-5">
                    <a href="{{ route('district-taluka-transfer.create') }}" class="btn btn-success">
                        Transfer Stock
                    </a>
                </div>
            </div><br><br>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-column" style="white-space:nowrap;">
                                <x-action-buttons
                                    :view-url="route('district-taluka-transfer.show', $t->id)"
                                    :edit-url="route('district-taluka-transfer.edit', $t->id)"
                                    :delete-url="route('district-taluka-transfer.destroy', $t->id)"/>
                            </td>
                        </tr>
                        @empty
                        <tr>
