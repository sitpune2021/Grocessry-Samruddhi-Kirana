...
class DistrictToTalukaApprovalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('approval.DistrictToTalukaTransfer', compact('transfers'));
    }

    public function approve(DistrictToTalukaTransfer $transfer)
    {
    ...
    public function reject(DistrictToTalukaTransfer $transfer)
    {
