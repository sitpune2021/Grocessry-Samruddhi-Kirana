...
class TalukaToDistributionApprovalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('approval.TalukatoshopTransfer', compact('transfers'));
    }

    public function approve(TalukashopTransfer $transfer)
    {
    ...
    public function reject(TalukashopTransfer $transfer)
    {
