...
class DistrictToDistrictApprovalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('approval.districttodistrictransfer', compact('transfers'));
    }

    public function approve(DistrictToDistrict $transfer)
    {
    ...
    public function reject(DistrictToDistrict $transfer)
    {
